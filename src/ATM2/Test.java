...
public class Test {
	public static List<Account1> usersList;
	public static Account1 currentAccount;//登录的用户
	...
	public static void main(String[] args)throws Exception {
		...
		usersList = new ArrayList<Account1>();
	...
	public static void usersListRead()
	{
		...
		try {
			...
			while ((temp = bfr.readLine()) != null) {//不知为何读取出的字符串中最前面会出现Null
				...
				Account1 a = new Account1(tmpstr[0], tmpstr[1], tmpstr[2]);
				usersList.add(a);
